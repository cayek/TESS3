...
and on Linux, Mac and Windows operating systems. 
...
build} directory. Copy the executable program file to the \verb|TESS3-master| directory, and 
...
the {\tt tess2tess3} function implemented in the {\tt R} package {\tt tess3r}.
