...
#
#' @export
cov.function.squared.exp <- function(sigma) {
  function(X,Y){
...
#
#' @export
sample.gaussian.process.Q <- function(cov.function) {
  function(coord, n, K,...) {
    # compute cov
...
#
#' @export
sample.dist.from.center.Q <- function(sigma) {
...
#
#' @export
sample.dist.from.center.dirichlet.Q <- function() {
  function(coord, n, K,mu,...) {
...
#
#' @export
sampleTESS2.3 <- function(n.by.pop, L, d, K, Q.sampler = sample.dist.from.center.dirichlet.Q()) {
